...
tinymce.init({
    ...
    menubar: true, // 隐藏菜单栏，显示请设置为true，false为关闭
    ...
    plugins: ['advlist', 'anchor', 'autolink', 'autoresize', 'autosave', 'axupings', 'bbcode', 'charmap', 'code', 'codesample', 'colorpicker', 'contextmenu', '-directionality', 'emoticons', 'fullpage', 'fullscreen', 'help', 'hr', 'image', '-insertdatetime', 'link', 'lists', 'media', 'paste', '-powerpaste', 'preview',  'imgetools', 'importcss', 'quickbars', 'table', 'textpattern', 'toc', 'visualblocks', '-visualchars', 'xiunoimgup', 'wordcount', 'paragraphspacing', 'emoticons'], // 加载的插件，-为禁用
    toolbar: ['fontformats code | undo redo | styleselect | formatting fontcolor removeformat | alignment blockquote indentation list | imgup link media codesample table | anchor hr toc preview | other | fullscreen | emoticons | paragraphspacing', t_external_toolbar.join(' ')], // 界面按钮
    toolbar_groups: { //按钮分组，节省空间，方便使用
        paragraphspacing: {
            icon: 'paragraphspacing',
            tooltip: 'other',
            items: 'paragraphspacing'
        },
        formatting: {
            icon: 'format',
            tooltip: '格式化',
